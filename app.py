...
def main():
    ...
    with st.container():
        st.success(churn)
        st.markdown('<h2 style="font-size:large;">Reminder!!!. Model accuracy did not exceed 80%. Taking this into account, the model may show an error result.</h2>', unsafe_allow_html=True)
